...
namespace Thapnath\CleanBlogBundle\Helper;
...
class ContentHelper
{
    ...
    public function getTopContent($offset = 0, $limit = 5)
    {
        $criteria = array(
            new Criterion\Subtree('/1/2/'),
            new Criterion\Visibility(Criterion\Visibility::VISIBLE),
    ...
    public function getFeaturedContent($offset = 0, $limit = 5)
    {
        $criteria = array(
            new Criterion\Subtree('/1/2/'),
            new Criterion\Visibility(Criterion\Visibility::VISIBLE),
    ...
    {
        $criteria = array(
            new Criterion\Subtree('/1/'),
            new Criterion\Visibility(Criterion\Visibility::VISIBLE),
            new Criterion\ContentTypeIdentifier(array('blog', 'folder'))
        );
        $query = new Query(
                array(
            'criterion' => new Criterion\LogicalAnd($criteria),
